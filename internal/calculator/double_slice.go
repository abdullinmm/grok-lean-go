...
// DoubleSlice takes a slice of numbers and returns a new slice with doubled values.
...
// DoubleSliceWithFunc takes a slice of numbers and returns a new slice with doubled values
